...
g++ -g -std=c++0x -mcmodel=medium -Wall \
	$1.cc  Tree_trigger.cc HadWake.cc Wake.cc dEdx.cc SonsMomenta.cc Eloss.cc Quench.cc Glauber_PbPb.cc Hydro_PbPb.cc Random.cc Parton.cc Hadron.cc Lund.cc -o $1 \
