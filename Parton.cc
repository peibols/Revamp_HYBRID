...
Parton::Parton(vector<double> p, double tf, double mass, int mom, int d1, int d2, int id, std::string orig, int col, int acol, bool isdone)
{
	_p=p;
...
void Parton::SetTf(double tf)
{
        _tf=tf;
}
double Parton::GetTf() const
{
        return _tf;
}
